...
<section class="default-page">
  ...
  <section id="founder" class="page-section animate-slide-up">
    ...
    <ul class="section-list">
      <li><strong>Credly:</strong> <a href="https://www.credly.com/users/ns408" target="_blank" rel="noopener noreferrer">Verified cloud and technology badges</a></li>
      <li><strong>Google Cloud Skills Boost:</strong> <a href="https://www.skills.google/public_profiles/9b1b0e16-df69-48bc-95b5-1c56ade2ffc6" target="_blank" rel="noopener noreferrer">Public profile</a></li>
    </ul>

    <h4><i class="fas fa-share-alt"></i> Connect</h4>
    <ul class="section-list">
      <li><i class="fab fa-linkedin"></i> <strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/ns408/" target="_blank" rel="noopener noreferrer">linkedin.com/in/ns408</a></li>
      <li><i class="fab fa-github"></i> <strong>GitHub:</strong> <a href="https://github.com/ns408" target="_blank" rel="noopener noreferrer">github.com/ns408</a></li>
    </ul>

    <h4><i class="fas fa-trophy"></i> Hackathons &amp; Community Work</h4>
    <ul class="section-list">

...
def find_test_pages() -> List[Tuple[str, str]]:
    ...
    test_pages = [
        ...
        ("/blog/orchestrating-devops-dominance/", "_site/blog/orchestrating-devops-dominance/index.html"),
...
def validate_breadcrumb_schema(schema: Optional[dict]) -> Tuple[bool, List[str]]:
    ...
    for i, item in enumerate(items):
        ...
        has_item_name = isinstance(item.get("item"), dict) and "name" in item.get("item", {})
        ...
        if "item" in item:
            ...
            if isinstance(item_url, str):
                ...
                url_without_protocol = item_url.replace("https://", "").replace("http://", "")

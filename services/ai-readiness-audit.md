...
<section class="default-page">
  ...
  <section class="page-section animate-slide-up delay-2">
    <h2><i class="fas fa-calendar-alt"></i> How It Works</h2>
    <p>Four structured phases deliver a clear, evidence-based picture of your readiness in two weeks.</p>
    <ol class="phase-timeline">
      <li>
        <div>
          <strong>Kick-off: Day 1 (2 hours)</strong><br>
          Align on scope, stakeholders, and access requirements. Set expectations for the engagement.
        </div>
      </li>
      <li>
        <div>
          <strong>Discovery: Days 2 to 7</strong><br>
          Structured interviews, artefact review, and evidence gathering across all six dimensions. Read-only access to systems. 3 to 8 stakeholder interviews depending on tier.
        </div>
      </li>
      <li>
        <div>
          <strong>Analysis: Days 8 to 10</strong><br>
          Score consolidation, gap prioritisation, and roadmap drafting. Every score backed by evidence collected during discovery.
        </div>
      </li>
      <li>
        <div>
          <strong>Readout: Day 14 (3 hours)</strong><br>
          Presentation of findings, scored report walkthrough, and Q&amp;A with your leadership team.
        </div>
      </li>
    </ol>
  </section>
  ...
  <section class="page-section animate-slide-up">
    <h2><i class="fas fa-file-alt"></i> What You Get</h2>
    <ul class="section-list">
      <li><strong>Agentic AI Readiness Report:</strong> A scored, evidence-backed assessment across all six dimensions.</li>
      <li><strong>90-Day Prioritised Roadmap:</strong> Actionable steps ordered by business impact and feasibility.</li>
      <li><strong>Board-Ready Executive Summary:</strong> A concise one-pager for leadership and governance audiences.</li>
      <li><strong>Readout Session &amp; Q&amp;A:</strong> A live 3-hour walkthrough with your team to discuss findings and next steps.</li>
    </ul>
  </section>
  ...
  <section class="page-section animate-slide-up">
    ...
    <div class="pricing-table">
      ...
      <div class="pricing-card">
        ...
        <div class="pricing-card__price">AUD $2,500</div>
        <div class="pricing-card__description">3-hour scoping session + written heatmap within 48 hours</div>
        <ul class="pricing-card__features">
          <li>Lightweight gap assessment</li>
          <li>All six dimensions covered</li>
      ...
      <div class="pricing-card pricing-card--featured">
        <div class="pricing-card__badge">Core Product</div>
        <div class="pricing-card__header">
          <h3>Professional Audit</h3>
        </div>
        <div class="pricing-card__price">AUD $18,500</div>
        <div class="pricing-card__description">Mid-market organisations, 100 to 500 staff</div>
        <ul class="pricing-card__features">
          <li>2-week engagement</li>
          <li>All six assessment dimensions</li>
      ...
      <div class="pricing-card">
        ...
        <div class="pricing-card__price">AUD $32,000+</div>
        <div class="pricing-card__description">Large organisations, 500+ staff</div>
        <ul class="pricing-card__features">
          <li>3-week engagement</li>
          <li>All six assessment dimensions</li>
          <li>Extended stakeholder interviews</li>
          <li>Readiness Report + Roadmap</li>
    ...
    <p class="credit-note">Book a follow-on engagement within 30 days and part of your audit fee is credited: 25% for Professional, 30% for Enterprise.</p>
  </section>
  ...
  <section class="page-section animate-slide-up">
    ...
    <div class="faq-list">
      ...
      <details>
        ...
        <p>The Readiness Snapshot is a lightweight, 3-hour scoping session that gives you a written heatmap across all six dimensions within 48 hours. It is designed for organisations that want a fast, low-commitment read on their AI readiness before committing to a full audit. It also includes a tier recommendation if a deeper engagement makes sense.</p>
      </details>
      <details>
